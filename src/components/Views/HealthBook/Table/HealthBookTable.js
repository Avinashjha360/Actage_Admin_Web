...
export default function HealthBookTable(props) {
  ...
  return (
    <>
     <div className='entries1'>
          ...
          <div> <MultipleSelect name=" " size='medium' /></div>
      </div>
        ...
        <Table sx={{ minWidth: 700 }} aria-label="customized table">
          <TableHead>
            <TableRow>
              ...
              <StyledTableCell>Test Name<ArrowDownwardIcon sx={{ fontSize: 13 }} /><ArrowUpwardIcon sx={{ fontSize: 13 }} /></StyledTableCell>
              <StyledTableCell>Test Min Value<ArrowDownwardIcon sx={{ fontSize: 13 }} /><ArrowUpwardIcon sx={{ fontSize: 13 }} /></StyledTableCell>
              <StyledTableCell>Test Max Value<ArrowDownwardIcon sx={{ fontSize: 13 }} /><ArrowUpwardIcon sx={{ fontSize: 13 }} /></StyledTableCell>
              <StyledTableCell>Measurement Unit<ArrowDownwardIcon sx={{ fontSize: 13 }} /><ArrowUpwardIcon sx={{ fontSize: 13 }} /></StyledTableCell>
              <StyledTableCell>Result Type<ArrowDownwardIcon sx={{ fontSize: 13 }} /><ArrowUpwardIcon sx={{ fontSize: 13 }} /></StyledTableCell>
